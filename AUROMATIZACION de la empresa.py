...
# Pedimos al usuario que ingrese sus datos
    ...
    if usuario == ussercorrecto and contraseña==contraseñacorrecta:
        ...
        if pregunta1 == "si":
            ...
            temperaturas = [" 1: -25°C"," 2: -15°C"," 3: -5°C"," 4: 5°C"," 5: 15°C"," 6: 25°C"," 7: 35°C"," 8: 45°C"]

            for número in temperaturas :
            #print(número)
            
                print(número)
            temperatura =int(input("\nIngrese su nivel de temperatura: "))
        ...
        if pregunta3=="si":
            ...
            print("\n --No se Ejecutará el Cálculo de Áreas y Perímetros-- ")
        break
    else:
        print(" \nUsuario incorrecto ")
